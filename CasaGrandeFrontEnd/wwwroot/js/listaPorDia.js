document.addEventListener('DOMContentLoaded', function () {
    ...
    usuarioSelect.addEventListener("change", function () {
        ...
        if (usuarioFiltro === "all") {
            ...
            return; // Sale de la función si "all" está seleccionado
        }
        filas.forEach(fila => {
            ...
            celdas.forEach(celda => {
                ...
                consultas.forEach(consulta => {
                    ...
                    if (nombreUsuario.includes(usuarioFiltro)) {
                        ...
                        mostrarFila = true;   // Marca la fila para mostrarse si coincide algún usuario en ella
                        consulta.style.display = "";  // Muestra la consulta específica si coincide
                    } else {
                        consulta.style.display = "none"; // Oculta la consulta si no coincide
                    }
                });

                celda.style.display = mostrarCelda ? "" : "none"; // Muestra u oculta la celda según el filtro
            });

            fila.style.display = mostrarFila ? "" : "none"; // Muestra u oculta la fila completa según el filtro
        });
    });
