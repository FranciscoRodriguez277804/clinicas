...
function closePagoModal() {
    ...
    var loader = document.getElementById("kiader")
    modal.style.display = "none";
}
...
function showMenuHover(element) {
    // Encuentra el div de menuHover correspondiente al elemento
    const menuHover = element.closest('.consulta-item').querySelector('.menuHover');
    if (menuHover) {
        menuHover.style.display = 'block'; // Muestra el menú
    }
}

function hideMenuHover(element) {
    const menuHover = element.closest('.consulta-item').querySelector('.menuHover');
    if (menuHover) {
        menuHover.style.display = 'none'; // Oculta el menú
    }
}

function keepMenuHover(menuHover) {
    menuHover.style.display = 'block'; // Mantiene el menú visible
}
